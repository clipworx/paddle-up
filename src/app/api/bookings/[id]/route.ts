...
export async function GET(_req: Request, { params }: Params) {
  ...
  const court = data.courts as unknown as { name: string; locations: { name: string; payment_qr_url: string | null; payment_account_name: string | null; payment_account_number: string | null } | null } | null;
