...
export default function AccountPage() {
  ...
  async function onSaveNotifications(key: "notify_new_booking" | "notify_cancellation", value: boolean) {
    setNotifSaving(true);
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="rounded-xl border border-border bg-background p-6 space-y-4">
          ...
          <div className="space-y-3">
            {[
              { key: "notify_new_booking" as const, label: "New booking", description: "Get notified when a player books a court at your location.", value: notifyBooking, set: setNotifyBooking },
              ...
              <div key={key} className="flex items-start justify-between gap-4 py-2 border-t border-border first:border-t-0 first:pt-0">
                ...
                <button
                  ...
                  onClick={async () => {
                    const next = !value;
                    set(next);
                    await onSaveNotifications(key, next);
                  }}
